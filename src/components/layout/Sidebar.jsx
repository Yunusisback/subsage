                    ...
                    <NavLink
                        ...
                        className={({ isActive }) => cn(
                            ...
                            isActive
                                ...
                                : "text-zinc-500 hover:bg-white hover:text-zinc-800 hover:shadow-md hover:shadow-zinc-200/50"
                        )}
                            ...
                            <>
                                ...
                                {item.badge && (
                                    <span className={cn(
                                        ...
                                        isActive ? "bg-cyan-500 text-white" : "bg-cyan-100 text-cyan-600 group-hover:bg-white group-hover:shadow-sm"
                                    )}>
                                        {item.badge}
                                    </span>
                                )}
