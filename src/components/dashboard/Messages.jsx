...
const Messages = () => {
  ...
  return (
    <div className="h-[calc(100vh-140px)] animate-in fade-in slide-in-from-bottom-4 duration-500 pb-4 max-w-5xl mx-auto">
      ...
      {/* Tek Sohbet Ekranı */}
      <div className="h-full flex flex-col bg-white dark:bg-zinc-900 rounded-4xl border border-zinc-200 dark:border-zinc-700 shadow-xl shadow-zinc-200/50 dark:shadow-black/30 overflow-hidden relative">
            
            {/* Sohbet Başlığı */}
            <div className="p-4 md:p-6 border-b border-cyan-200 dark:border-zinc-700 flex justify-between items-center bg-zinc-50 dark:bg-zinc-800/80 backdrop-blur-md z-10 sticky top-0">
                <div className="flex items-center gap-4">
                    
                    {/* profil logo */}
                    <div className="relative">
                        <div className="w-12 h-12 bg-cyan-50 dark:bg-cyan-900/30 rounded-full flex items-center justify-center border border-cyan-100 dark:border-cyan-800 shadow-sm shrink-0 overflow-hidden">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-1.5">
                            <span className="text-xs text-cyan-600 dark:text-cyan-400 font-medium bg-cyan-50 dark:bg-cyan-900/30 px-2 py-0.5 rounded-full border border-cyan-100 dark:border-cyan-800">
                                {contactInfo.role}
                            </span>
                        </div>
                    </div>
                ...
                <div className="flex items-center gap-1">
                    <Button variant="ghost" size="icon" className="text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 hover:bg-zinc-100 dark:hover:bg-zinc-700 rounded-full cursor-pointer">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6 bg-slate-50 dark:bg-zinc-950 relative custom-scrollbar">
                ...
                <div className="flex justify-center my-6 relative z-10">
                    <div className="bg-white/80 dark:bg-zinc-800/80 backdrop-blur-sm text-zinc-500 dark:text-zinc-400 px-4 py-1.5 rounded-full text-[10px] font-semibold border border-zinc-200 dark:border-zinc-700 flex items-center gap-1.5 shadow-sm select-none">
                ...
                {activeMessages.length === 0 && (
                    <div className="flex flex-col items-center justify-center h-64 text-zinc-400 relative z-10">
                         <div className="w-20 h-20 bg-white dark:bg-zinc-800 rounded-full flex items-center justify-center mb-4 shadow-sm border border-zinc-100 dark:border-zinc-700">
                            <Headset size={40} className="text-cyan-200 dark:text-cyan-700" />
                         </div>
                        ...
                        >
                            <div className={cn(
                                ...
                                isMe 
                                    ...
                                    : "bg-white dark:bg-zinc-800 text-zinc-700 dark:text-zinc-200 border border-zinc-100 dark:border-zinc-700 rounded-3xl rounded-tl-none" 
                            )}>
            ...
            {/* İnput alanı */}
            <div className="p-3 md:p-4 bg-white dark:bg-zinc-900 border-t border-zinc-100 dark:border-zinc-800 z-20">
                <form onSubmit={handleSend} className="flex items-end gap-2 md:gap-3">
                    ...
                    <div className="flex items-center gap-1 pb-1">
                        ...
                        <Button 
                            ...
                            variant="ghost" 
                            size="icon" 
                            className="w-10 h-10 text-zinc-400 hover:text-cyan-600 dark:hover:text-cyan-400 hover:bg-cyan-50 dark:hover:bg-cyan-900/30 rounded-full transition-colors duration-200"
                            title="Dosya Ekle"
                        >
                    ...
                    <div className="flex-1 relative bg-slate-100 dark:bg-zinc-800 rounded-3xl flex items-center min-h-12.5 border border-transparent focus-within:border-cyan-200 dark:focus-within:border-cyan-700 focus-within:bg-white dark:focus-within:bg-zinc-700 focus-within:ring-4 focus-within:ring-cyan-50/50 dark:focus-within:ring-cyan-900/20 transition-all duration-300">
                        <input 
                            type="text" 
                            value={inputText}
