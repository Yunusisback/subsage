...
const WalletView = () => {
  ...
  const QUICK_ACTIONS = [
      { icon: Lock, label: "Kartı Dondur", color: "text-rose-600 dark:text-rose-400", bg: "bg-rose-50 hover:bg-rose-100 border-rose-100 dark:bg-rose-950/30 dark:hover:bg-rose-900/40 dark:border-rose-900/50" },
      { icon: FileText, label: "Hesap Özeti", color: "text-blue-600 dark:text-blue-400", bg: "bg-blue-50 hover:bg-blue-100 border-blue-100 dark:bg-blue-950/30 dark:hover:bg-blue-900/40 dark:border-blue-900/50" },
      { icon: Shield, label: "Limit Ayarları", color: "text-emerald-600 dark:text-emerald-400", bg: "bg-emerald-50 hover:bg-emerald-100 border-emerald-100 dark:bg-emerald-950/30 dark:hover:bg-emerald-900/40 dark:border-emerald-900/50" },
      { icon: Settings, label: "Kart Ayarları", color: "text-zinc-600 dark:text-zinc-300", bg: "bg-zinc-50 hover:bg-zinc-100 border-zinc-200 dark:bg-zinc-800/60 dark:hover:bg-zinc-700/60 dark:border-zinc-700/60" },
  ];
    ...
    <div className="animate-in fade-in zoom-in-95 duration-500 pb-10">
      ...
      <div className="flex flex-col gap-6 lg:gap-8">
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 items-stretch">
            ...
            <div className="w-full lg:w-95 xl:w-105 shrink-0 space-y-6 flex flex-col justify-center">
                
                {/* Başlık ve Ekle Butonu */}
                <div className="flex items-center justify-between px-1">
                    <h2 className="text-xl font-bold text-cyan-700 dark:text-cyan-400 tracking-tight">Kartlarım</h2>
                    <Button size="sm" className="flex items-center gap-1.5 pl-3 pr-4 py-2 rounded-full font-semibold bg-cyan-700 hover:bg-cyan-500 text-white shadow-lg shadow-cyan-200/50 dark:shadow-cyan-900/30 transition-all hover:scale-105 active:scale-95 cursor-pointer">
               ...
               {/*Kredi Kartı Alanı*/}
                <motion.div 
                    className="relative w-full aspect-[1.586/1] rounded-4xl overflow-hidden shadow-[0_20px_50px_-12px_rgba(0,0,0,0.3)] dark:shadow-[0_20px_60px_-12px_rgba(0,0,0,0.6)] cursor-pointer group"
            ...
            <div className="flex-1 w-full flex flex-col justify-end mt-6 lg:mt-0">
                {/* Limit Kontrolü */}
                <BentoCard 
                    glowColor={fillPercentage >= 100 ? "red" : "cyan"} 
                    className={cn(
                        "p-5 sm:p-6 shadow-lg relative overflow-hidden group/limit transition-all duration-500 w-full lg:h-60 xl:h-66.25 flex flex-col justify-between",
                ...
                >
                    ...
                    <div className="relative z-10 flex flex-col items-center justify-center text-center my-auto">
                        <span className="text-[10px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-wider mb-1">Kullanılan Tutar</span>
                        <div className="flex items-baseline justify-center gap-1">
                            <span className="text-4xl lg:text-3xl xl:text-4xl font-black text-zinc-900 dark:text-zinc-100 tracking-tight">{formatCurrency(currentSpend)}</span>
                        </div>
                        <span className="text-xs font-semibold text-zinc-400 dark:text-zinc-500 mt-1">/ {formatCurrency(localLimit)}</span>
                    </div>

                    <div className="relative z-10 mt-3 pt-3 border-t border-zinc-100/80 dark:border-zinc-800/60">
                        <div className="flex justify-between items-end mb-1.5">
                            <span className="text-[10px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-wider">Doluluk</span>
                            <span className={cn(
                        ...
                        <div className="h-2 w-full bg-zinc-100 dark:bg-zinc-800 rounded-full overflow-hidden shadow-inner relative mb-3">
                            <motion.div 
                                className={cn(
                        ...
                        <div className="flex justify-between text-[10px] font-bold text-zinc-400 dark:text-zinc-500 mb-1.5 uppercase tracking-wider">
                        ...
                        <div className="relative h-5 flex items-center group/slider">
                            <div className="absolute w-full h-1.5 bg-zinc-100 dark:bg-zinc-800 rounded-full overflow-hidden shadow-inner">
                                <motion.div 
                                    className="h-full bg-linear-to-r from-zinc-300 to-zinc-400 dark:from-zinc-600 dark:to-zinc-500 opacity-60 transition-all duration-300"
                            ...
                            <motion.div 
                                className="absolute h-5 w-5 bg-white dark:bg-zinc-200 rounded-full shadow-md shadow-zinc-300/50 dark:shadow-black/40 border-[3px] border-cyan-500 z-10 pointer-events-none transition-colors group-hover/slider:border-cyan-400"
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-2">
            ...
            {QUICK_ACTIONS.map((action, index) => (
                <button 
                    key={index} 
                    className={cn(
                        "flex flex-col items-center justify-center text-center p-4 rounded-3xl transition-all duration-300 border shadow-xs hover:shadow-md hover:-translate-y-0.5 active:translate-y-0 active:scale-95 group cursor-pointer",
                        action.bg
                    )}
                >
                    <div className={cn(
                        "p-2.5 rounded-2xl mb-3 bg-white dark:bg-zinc-800 shadow-sm group-hover:scale-110 transition-transform",
                        action.color
                    )}>
                        <action.icon size={22} strokeWidth={2.5} />
                    </div>
                    <span className="text-xs font-bold text-zinc-700 dark:text-zinc-300">{action.label}</span>
                </button>
            ))}
        </div>
        ...
        <div className="w-full mt-2">
            ...
            <div className="flex-1 min-w-0 w-full">
                <BentoCard 
                    glowColor="zinc" 
                    className={cn(
                        "h-fit p-0 overflow-hidden flex flex-col rounded-4xl w-full",
                        "bg-white dark:bg-zinc-900/80",
                ...
                >
                    ...
                    {/* Header ve araçlar */}
                    <div className={cn(
                        "p-6 sm:p-8 border-b flex flex-col sm:flex-row sm:items-center justify-between gap-4 sticky top-0 z-30",
                        ...
                        <div>
                            ...
                            <p className="text-zinc-400 dark:text-zinc-500 text-xs font-medium mt-1">Kart harcamalarınızın detaylı dökümü</p>
                        </div>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            {/* Arama Kutusu */}
                            <div className={cn(
                                "flex items-center rounded-2xl transition-all duration-200 ease-out overflow-hidden",
                                "bg-zinc-50 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700",
                                isSearchOpen 
                                    ? "w-full sm:w-64 pl-3 pr-1 shadow-inner" 
                                    : "w-10 h-10 justify-center border-transparent bg-transparent"
                            )}>
                                {isSearchOpen && (
                                    <input 
                                        ref={searchInputRef}
                                        ...
                                        className="w-full bg-transparent border-none focus:outline-none text-sm font-medium text-zinc-700 dark:text-zinc-200 placeholder:text-zinc-400 dark:placeholder:text-zinc-500 h-10"
                                    />
                                )}
                                ...
                                <button 
                                    ...
                                    className={cn(
                                        ...
                                        isSearchOpen 
                                            ? "w-8 h-8 hover:bg-zinc-200 dark:hover:bg-zinc-700 text-zinc-500 dark:text-zinc-400" 
                                            : "w-10 h-10 hover:bg-zinc-100 dark:hover:bg-zinc-800 text-cyan-500 hover:text-zinc-900 dark:hover:text-zinc-100"
                                    )}
                                >
                            ...
                            <button 
                                ...
                                className={cn(
                                    "p-2.5 rounded-2xl transition-all cursor-pointer group",
                                    "bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700",
                                    "text-cyan-500 hover:text-zinc-900 dark:hover:text-zinc-100",
                    ...
                    <div className="flex-1 overflow-x-auto custom-scrollbar p-2">
                        <table className="w-full text-left border-collapse">
                            <thead className={cn(
                                "text-[10px] uppercase tracking-wider font-bold border-b",
                                            ...
                                            >
                                                <td className="px-6 py-4 pl-8">
                                                    <div className="flex items-center gap-4">
                                                        <div className={cn(
                                                            "w-12 h-12 rounded-[18px] flex items-center justify-center shadow-sm border p-2.5 group-hover:scale-110 group-hover:shadow-md transition-all duration-300",
                                                            ...
                                                            {tx.icon ? (
                                                                ...
                                                                <CreditCard size={20} className="text-zinc-300 dark:text-zinc-500" />
                                                            )}
                                                        </div>
                                                        <div>
                                                            <p className="text-sm font-bold text-zinc-900 dark:text-zinc-100 transition-colors">{tx.name}</p>
                                                            <p className="text-[10px] font-medium text-zinc-400 dark:text-zinc-500 sm:hidden">{tx.date}</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td className="px-6 py-4 text-xs font-semibold text-zinc-500 dark:text-zinc-400 hidden md:table-cell">
                                                    {tx.date}
                                                </td>
                                                
                                                <td className="px-6 py-4 text-right pr-8">
                                                    <div className="flex flex-col items-end">
                                                        <span className="text-sm font-black tracking-tight text-red-600 dark:text-red-400 group-hover:text-cyan-700 dark:group-hover:text-cyan-300 transition-colors">
                                                            {formatCurrency(tx.amount)}
                                                        </span>
                                                        <span className="text-[10px] font-bold text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/40 px-1.5 py-0.5 rounded flex items-center gap-0.5 mt-0.5">
                                            ...
                                            <td colSpan={4} className="py-20 text-center">
                                                <div className="flex flex-col items-center justify-center opacity-50">
                                                    <div className="w-16 h-16 bg-zinc-100 dark:bg-zinc-800 rounded-full flex items-center justify-center mb-4">
                                                        <Search size={24} className="text-zinc-400 dark:text-zinc-500" />
                                                    </div>
                    ...
                    {filteredTransactions.length > 5 && (
                        <div className={cn(
                            "p-4 border-t flex justify-center backdrop-blur-sm",
                            ...
                            <button 
                                ...
                                className={cn(
                                    "group flex items-center gap-2 px-6 py-2.5 rounded-full text-xs font-bold transition-all duration-300 cursor-pointer border",
                                    "text-zinc-600 dark:text-zinc-300",
                                    "bg-white dark:bg-zinc-800",
                                    "border-zinc-200 dark:border-zinc-700",
                                    "hover:border-zinc-300 dark:hover:border-zinc-600",
                                    "hover:text-zinc-900 dark:hover:text-zinc-100 hover:shadow-md dark:hover:shadow-black/30"
                                )}
                            >
                                {isExpanded ? (
                                    <>
                                    ...
                                    <>
                                        Tümünü Göster 
                                        <span className="bg-zinc-100 dark:bg-zinc-700 text-zinc-500 dark:text-zinc-400 px-1.5 py-0.5 rounded text-[10px] group-hover:bg-zinc-200 dark:group-hover:bg-zinc-600 transition-colors">
        ...
        <div className="p-4">
            ...
            {limitStep === 'confirm' && (
                <div className="animate-in fade-in zoom-in-95 duration-300">
                    <div className="bg-linear-to-br from-red-500 to-red-900 border border-red-400/30 rounded-3xl p-6 flex flex-col items-center text-center gap-4 mb-8">
                        <div className="bg-white p-4 rounded-full shadow-lg shadow-red-900/30 ring-4 ring-white/10 text-red-600">
                                <Shield size={32} />
                        </div>
                        <div>
                            <h4 className="font-bold text-white text-lg mb-2">Limit Güncelleme</h4>
                            <div className="flex items-center justify-center gap-3 text-2xl font-black tracking-tight my-2">
                                <span className="text-white/50 line-through text-lg">{formatCurrency(spendingLimit)}</span>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <Button 
                            variant="ghost" 
                            onClick={cancelLimitUpdate} 
                            className="rounded-3xl h-12 font-bold text-white hover:bg-red-500 bg-zinc-500 dark:bg-zinc-600 cursor-pointer hover:scale-90"
                        >
                            Vazgeç
                        </Button>
                        <Button 
                            onClick={startLimitUpdateProcess} 
                            className="bg-red-600 hover:bg-red-700 text-white shadow-lg shadow-red-500/20 dark:shadow-red-900/30 rounded-3xl h-12 cursor-pointer hover:scale-90 border-transparent"
                        >
                            Onayla ve Güncelle
                        </Button>
                    </div>
                ...
                <div className="py-12 flex flex-col items-center justify-center text-center animate-in fade-in zoom-in-95 duration-300">
                    <div className="relative mb-6">
                        ...
                        <div className="relative bg-white dark:bg-zinc-800 p-5 rounded-full shadow-xl shadow-red-100 dark:shadow-red-900/20 border border-red-50 dark:border-red-900/30">
                            <Loader2 size={40} className="text-red-600 dark:text-red-400 animate-spin" />
                        </div>
                    </div>
